		...
		return (
			<div className="location_page">
				<Helmet>
					...
					<title>Location - The Elite Cars | The True Definition of Luxury</title>
					...
					<meta name="og:title" property="og:title" content="Location - The Elite Cars | The True Definition of Luxury" />
