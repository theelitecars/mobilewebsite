...
class MenuSlide extends Component {
	...
	render() {
		...
		const { menuVisibility, handleMenuButton } = this.props;

		let slideToggle = {
			left: menuVisibility ? "0px" : "-300px",
		}
		...
		return (
			<div className="menu-slide">
				<div className="overlay" onMouseDown={handleMenuButton} style={overlay}></div>
				<div className="ms-container" style={slideToggle}>
